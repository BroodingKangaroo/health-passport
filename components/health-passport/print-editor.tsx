...
import type { PrintLang } from '@/components/health-passport/print-setup'
...
type DateCol = { id: string; year: string; short: string; ru: string }

const ALL_DATES: DateCol[] = [
  { id: 'oct', year: '2026', short: 'Oct 12', ru: '12.10.26' },
  { id: 'sep', year: '2026', short: 'Sep 05', ru: '05.09.26' },
  { id: 'mar', year: '2026', short: 'Mar 06', ru: '06.03.26' },
  { id: 'jan', year: '2026', short: 'Jan 15', ru: '15.01.26' },
  { id: 'aug25', year: '2025', short: 'Aug 18', ru: '18.08.25' },
  { id: 'feb25', year: '2025', short: 'Feb 02', ru: '02.02.25' },
]

// Most-recent-first chronological order used for presets + column order.
const CHRONO = ['oct', 'sep', 'mar', 'jan', 'aug25', 'feb25']
...
const MARKERS: Record<string, Marker> = {
  ...
  lymph: {
    ...
    values: {
      oct: { v: '41.0', abnormal: true },
      sep: { v: '32.0' },
      mar: { v: '52.7', abnormal: true },
      jan: { v: '40.8', abnormal: true },
      aug25: { v: '35.0' },
      feb25: { v: '38.0' },
    },
  },
  ferr: {
    ...
    values: {
      oct: { v: '22.0', abnormal: true },
      sep: { v: '28.5', abnormal: true },
      mar: { v: '32.0' },
      jan: { v: '16.2', abnormal: true },
      aug25: { v: '50.4' },
      feb25: { v: '41.5' },
    },
  },
...
type Category = { id: string; name: string; markers: string[] }
...
export function PrintEditor({
  ...
  const [activeDates, setActiveDates] = useState<string[]>(['oct', 'sep'])
  ...
  // Ordered, filtered structure for the preview table.
