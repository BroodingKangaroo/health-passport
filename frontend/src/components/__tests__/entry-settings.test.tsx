...
const bloodTestBiomarkers: BiomarkerResult[] = [
  {
    id: 'wbc', value: 5.0, date: '2026-12-15', status: 'normal',
  ...
  {
    id: 'glu', value: 120, date: '2026-12-15', status: 'high',
  ...
  {
    id: 'hb', value: 11, date: '2026-12-15', status: 'low',
  ...
  {
    id: 'hcg', value: 'Positive', date: '2026-12-15', status: 'abnormal',
