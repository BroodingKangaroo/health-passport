...
const API_FALLBACKS = {
  en: {
    ...
    changeEmailFailed: 'POST /auth/change-email failed',
    confirmEmailChangeFailed: 'POST /auth/confirm-email-change failed',
    emailDeliveryStatusFailed: 'GET /auth/email-delivery failed',
    ...
    postShareNoticeAckFailed: 'POST /share/notice/ack failed',
  ...
  ru: {
    ...
    changeEmailFailed: 'Не удалось изменить email',
    confirmEmailChangeFailed: 'Не удалось подтвердить новый email',
    emailDeliveryStatusFailed: 'Не удалось проверить настройки отправки писем',
    ...
    postShareNoticeAckFailed: 'Не удалось подтвердить уведомление',
