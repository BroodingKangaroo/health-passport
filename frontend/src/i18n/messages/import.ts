...
export const importMessages = {
  en: {
    import: {
      ...
      trackerSaved: 'Saved',
      trackerMetaSubmitted: 'Submitted {time}',
      trackerMetaExtracted: 'Extracted {time}',
      trackerMetaFailed: 'Failed {time}',
      trackerMetaSaved: 'Saved {time}',
      trackerMetaCancelled: 'Cancelled {time}',
  ...
  ru: {
    import: {
      ...
      trackerMetaSubmitted: 'Отправлен: {time}',
      trackerMetaExtracted: 'Распознан: {time}',
      trackerMetaFailed: 'Ошибка: {time}',
      trackerMetaSaved: 'Сохранён: {time}',
      trackerMetaCancelled: 'Отменён: {time}',
