"""Unit tests for the F6/F8/F9/F10 harness surfaces: report comparison
verdicts, screen-mode argument resolution, corpus manifest hashing/drift, and
snapshot-input fingerprints. No network, no app imports, no DB."""

import json

import pytest

from benchmark.compare_reports import compare_reports
...
def test_cost_tie_break_is_informational_on_exact_tie():
    new = _report(0.90)
